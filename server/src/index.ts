...
import scheduleRulesRouter from './routes/scheduleRules';
import scheduleProposalsRouter from './routes/scheduleProposals';
...
app.use('/api/schedule-rules', scheduleRulesRouter);
app.use('/api/schedule-proposals', scheduleProposalsRouter);
