...
export const api = {
  ...
  uploadAccountAvatar: (input: { fileName: string; mimeType?: string | null; contentBase64: string }) =>
    req<{ user: User }>('/account/avatar', { method: 'POST', body: JSON.stringify(input) }).then((r) => r.user),
